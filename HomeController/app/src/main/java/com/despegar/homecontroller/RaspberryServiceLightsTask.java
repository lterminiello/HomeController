...
public class RaspberryServiceLightsTask extends AsyncTask<String, Void, Lights> {


        private listenerFragmen listenerFragmen;

        public RaspberryServiceLightsTask(listenerFragmen listenerFragmen) {
        ...
        protected void onPostExecute(Lights lights) {
            ...
            listenerFragmen.onFinish(lights);
        }
